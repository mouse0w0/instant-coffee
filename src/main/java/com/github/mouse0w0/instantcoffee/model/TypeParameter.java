...
public class TypeParameter extends Located {
    ...
    public TypeParameter(Location location, String name, List<ReferenceType> bounds, boolean isImplementation) {
        super(location);
        this.name = name;
        this.bounds = bounds;
    ...
    public String toString() {
        ...
        StringBuilder builder = new StringBuilder(name).append(isImplementation ? " implements " : " extends ");
